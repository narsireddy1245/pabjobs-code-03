        ...
        <div class=" d-flex  parent-container">
          ...
          <div class="col-md-8 p-4 allJobsContainer">
            <div class="d-flex flex row ">
              ...
              <div class="row">
                <div class="col-md p-1 m-1">
                  ...
                  <button class="locationBtn12  w-100 p-1 m-1">
                    {" "}
                    <img
                      src="https://pbs.twimg.com/media/CQLNvOVVEAEOVY8.png"
                      alt=""
                      width="50px"
                      height="30px"
                      className="px-2"
                ...
                <div class="col-md p-1 m-1 ">
                  <button class="locationBtn12 locationBtn  w-100 p-1 m-1 ">
                    <img
                ...
                <div class="col-md p-1 m-1">
                  <button class="locationBtn12 locationBtn  w-100 p-1 m-1 ">
                    {" "}
                    <img
                      src="https://cdn.dribbble.com/users/460946/screenshots/3009895/madrascentral.jpg"
                      alt=""
                      width="50px"
                      height="30px"
                      className="px-2"
              ...
              <div class="row">
                <div class="col-md p-1 m-1">
                  <button class="locationBtn12 locationBtn  w-100 p-1 m-1 ">
                    <img
                      src="https://4.bp.blogspot.com/-HGizM-_b0Hg/WSWHqWJfm2I/AAAAAAAAAqU/RcdAdLTSViotovXVOJcJNe3odAlhRSv0gCLcB/s1600/L-112.JPG"
                      alt=""
                      width="50px"
                      height="30px"
                      className="px-2"
                ...
                <div class="col-md p-1 m-1">
                  <button class="locationBtn12 locationBtn  w-100 p-1 m-1 ">
                    <img
                      src="https://www.juliusbaer.com/fileadmin/_processed_/d/e/csm_location-bangalore_1eb4596c40.png"
                      alt=""
                      width="50px"
                      height="30px"
                      className="px-2"
                  ...
                  <div class="col-md-12">
                    <div class="d-flex flex-column">
                      ...
                      >
                        ...
                        <div class="logo">
                          <img
                            src="https://companieslogo.com/img/orig/TCS.NS_BIG-89c50e39.png?t=1631949260"
                            class="w-50"
                            alt="Company 2"
                          />
                        </div>
                        <div class="logo">
                          <img
                            src="https://cdn.imgbin.com/15/20/23/imgbin-capgemini-logo-business-insuretech-connect-cfo-rising-europe-summit-others-capgemini-logo-Yy2qm7xHfwk9vBN3cYREqKiKQ.jpg"
                            class="w-50"
                            alt="Company 3"
                          />
                        </div>
                        ...
                        <div class="logo">
                          <img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnvsuEQaCvXWYaEcoVKx6ODh2Q8BznHCDHX6fc2BVa-Q&s"
                            class="w-50"
                            alt="Company5"
                          />
                        </div>
                        <div class="logo">
                          <img
                            src="https://w7.pngwing.com/pngs/507/564/png-transparent-abb-group-solar-inverter-corporation-company-egypt-national-football-angle-company-text.png"
                            class="w-50"
                            alt="Company6"
                          />
                        </div>
            ...
            <div class="d-flex flex row">
              ...
              <div class="row">
                <div class="col-md p-1 m-1">
                  <button class="locationBtn12 w-100 p-2 m-1">
                    {" "}
                    <i class="fa-solid fa-plane-departure p-2"></i> Airline
                  </button>
                </div>
                <div class="col-md p-1 m-1">
                  <button class="locationBtn12 w-100 p-2 m-1">
